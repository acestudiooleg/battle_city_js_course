...
У цьому підрозділі ми додамо функціональність стрільби до класу `Enemy.js` з автоматичною стрільбою при зміні напрямку та за таймером. Тепер ворожий танк зможе стріляти!
