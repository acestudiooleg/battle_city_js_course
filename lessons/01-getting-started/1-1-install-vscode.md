...
Уяви собі, що у тебе є чарівний блокнот, який розуміє мову комп'ютера і може створити все, що ти захочеш. Ось що таке VS Code! Він допоможе нам писати код легко та швидко!
...
## 🔌 Встановлюємо Live Server

**⚠️ Важливо!** Нам обов'язково потрібне розширення **Live Server** — воно запускає маленький сервер прямо на твоєму комп'ютері, щоб гра працювала коректно.

1. Відкрий VS Code
2. Натисни **Ctrl+Shift+X** (або знайди іконку пазлів 🧩 зліва)
3. В пошуку напиши **"Live Server"**
...
Після встановлення ти повинен мати:
- ✅ VS Code відкривається без помилок
- ✅ У бічній панелі є іконка розширень (пазли 🧩)
- ✅ Live Server встановлено (в списку розширень є зелена галочка)

**Вітаю! Інструменти готові!** 🎊 Переходимо до створення проєкту!
