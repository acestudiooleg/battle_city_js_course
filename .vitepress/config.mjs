    ...
    sidebar: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '9.1: Штаб — Орел (Eagle)', link: '/lessons/09-eagle-gamestate/9-1-eagle-base' },
              { text: '9.2: Куля vs штаб', link: '/lessons/09-eagle-gamestate/9-2-bullet-vs-eagle' },
              { text: '9.3: Game Over', link: '/lessons/09-eagle-gamestate/9-3-game-over' },
              { text: '9.4: Перемога та рестарт', link: '/lessons/09-eagle-gamestate/9-4-victory-restart' },
            ],
          },
          {
            text: 'День 10: Вороги',
            collapsed: true,
            items: [
              { text: '10.1: Клас Enemy', link: '/lessons/10-enemies/10-1-enemy-class' },
              { text: '10.2: Spawn-анімація', link: '/lessons/10-enemies/10-2-spawn-animation' },
              { text: '10.3: AI патрулювання', link: '/lessons/10-enemies/10-3-ai-patrol' },
              { text: '10.4: AI стрільба', link: '/lessons/10-enemies/10-4-ai-shooting' },
              { text: '10.5: Черга спавну', link: '/lessons/10-enemies/10-5-spawn-system' },
            ],
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '11.1: Що таке спрайт-лист', link: '/lessons/11-sprites/11-1-spritesheet-theory' },
              { text: '11.2: SpriteSheet.js', link: '/lessons/11-sprites/11-2-spritesheet-class' },
              { text: '11.3: Спрайти танків', link: '/lessons/11-sprites/11-3-tank-sprites' },
              { text: '11.4: Спрайти тайлів', link: '/lessons/11-sprites/11-4-tile-sprites' },
              { text: '11.5: Орел та fallback', link: '/lessons/11-sprites/11-5-eagle-fallback' },
            ],
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '12.1: SoundManager', link: '/lessons/12-sound-ui/12-1-sound-manager' },
              { text: '12.2: Відтворення звуків', link: '/lessons/12-sound-ui/12-2-play-sounds' },
              { text: '12.3: Sidebar (NES)', link: '/lessons/12-sound-ui/12-3-sidebar-nes' },
              { text: '12.4: CSS масштаб', link: '/lessons/12-sound-ui/12-4-css-scale' },
            ],
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '13.1: Клас PowerUp', link: '/lessons/13-powerups-multiplayer/13-1-powerup-class' },
              { text: '13.2: Спавн артефактів', link: '/lessons/13-powerups-multiplayer/13-2-powerup-spawn' },
              { text: '13.3: Ефекти артефактів', link: '/lessons/13-powerups-multiplayer/13-3-powerup-effects' },
              { text: '13.4: Мультиплеєр', link: '/lessons/13-powerups-multiplayer/13-4-multiplayer-input' },
              { text: '13.5: Game для 2 гравців', link: '/lessons/13-powerups-multiplayer/13-5-game-two-players' },
            ],
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '14.1: Титульний екран', link: '/lessons/14-title-final/14-1-title-screen' },
              { text: '14.2: Меню та інтро', link: '/lessons/14-title-final/14-2-menu-input' },
              { text: '14.3: Фінальне тестування', link: '/lessons/14-title-final/14-3-testing' },
