    ...
    sidebar: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '6.1: Формат карти', link: '/lessons/06-game-field/6-1' },
              { text: '6.2: levels.js', link: '/lessons/06-game-field/6-2' },
              { text: '6.3: GameField.js', link: '/lessons/06-game-field/6-3' },
              { text: '6.4: Вода та ліс', link: '/lessons/06-game-field/6-4' },
            ],
          },
          {
            text: 'День 7: Колізії',
            collapsed: true,
            items: [
              { text: '7.1: Теорія AABB', link: '/lessons/07-collisions/7-1' },
              { text: '7.2: CollisionManager', link: '/lessons/07-collisions/7-2' },
              { text: '7.3: Танк vs стіна', link: '/lessons/07-collisions/7-3' },
              { text: '7.4: Куля vs стіна', link: '/lessons/07-collisions/7-4' },
              { text: '7.5: Куля vs танк', link: '/lessons/07-collisions/7-5' },
            ],
          },
          {
            ...
            collapsed: true,
            items: [
              { text: '8.1: Клас Explosion', link: '/lessons/08-explosions/8-1' },
              { text: '8.2: Вибухи в Game.js', link: '/lessons/08-explosions/8-2' },
              { text: '8.3: Куля → вибух', link: '/lessons/08-explosions/8-3' },
              { text: '8.4: NES-руйнування цегли', link: '/lessons/08-explosions/8-4' },
            ],
          },
          {
