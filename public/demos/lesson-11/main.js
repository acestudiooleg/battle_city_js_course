// main.js — Урок 11: NES графіка (спрайти)
...
ctx.imageSmoothingEnabled = false; // Чіткі пікселі для NES графіки!
...
function drawVictory() {
    ...
    ctx.fillText('Натисніть R', FIELD_X+FIELD_W/2, FIELD_Y+FIELD_H/2+16);
}
...
function drawSidebar() {
    ...
    ctx.fillText('УРОК 11', sx+8, 30); ctx.fillText('NES графіка!', sx+8, 50);
