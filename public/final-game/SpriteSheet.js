...
/** 6 артефактів у рядку, кожен 16×16, y=112 */
export const POWERUP_SPRITES = {
  helmet:  { x: 256, y: 112 },  // каска — тимчасовий щит
  timer:   { x: 272, y: 112 },  // заморозка — замораживает врагов
  shovel:  { x: 288, y: 112 },  // лопата — бетон навколо штабу
  star:    { x: 304, y: 112 },  // зірка — підвищення рангу
  grenade: { x: 320, y: 112 },  // граната — вбиває всіх ворогів
  tank:    { x: 336, y: 112 },  // танк — додаткове життя
};
